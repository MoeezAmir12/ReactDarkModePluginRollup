...
const DarkModePlugin = (props) => {
    ...
    return (React.createElement("div", { "data-testid": "DarkModePlugin_Container", className: props.containerClassName ? props.containerClassName : "flex flex-row w-fit h-fit gap-1 p-[0.4rem] items-center rounded-full border-2 border-indigo-400 dark:bg-slate-400 dark:border-indigo-700 bg-slate-200" },
